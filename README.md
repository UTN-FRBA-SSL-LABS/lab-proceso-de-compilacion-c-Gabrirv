...
> **R:**Porque se incluyen las definiciones de las funciones de stdio.h
...
> **R:**La información que contienen es la ubicación del bloque usado, printf proviene del archivo stdio.h
...
> **R:**Porque en programa.o solo es llamado y en matematica.o es definido
...
> **R:**The file is not displayed in the text editor because it is either binary or uses an unsupported text encoding.
...
> **R:** Son funciones de la biblioteca dinámica del sistema ,los resuelve el cargador dinámico cuando el programa se ejecute.
...
> **R:**Las macros son ejecutadas en el preprocesamiento y desaparecen en esta fase, las funciones reales tienen verificación de tipos mientras que las macros no
...
> **R:**Los T están definidos en la sección texto y los D en la sección data
...
> **R:**Porque el compilador (gcc) lo hace por defecto
